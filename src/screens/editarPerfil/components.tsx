            ...
            <View style={{ flex: 1 }}>
                ...
                <View style={[styles.itemRes, { borderColor: props.borderColor }]}>
                    <View style={{ flexDirection: 'row' }}>
                        ...
                        <Image style={styles.itemImage} source={require('./../../assets/TheSpoilers.png')} />
                    ...
                    <Text style={[styles.itemResSubTitle, { color: props.itemSubTitle }]}>2 itens</Text>
                    <Text style={[styles.itemResSubTitle, { color: props.itemSubTitle }]}>Atualizado: mai 06, 2021</Text>
                </View>
            </View>
        </View>
    );
